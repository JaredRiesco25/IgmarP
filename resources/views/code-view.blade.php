...
<body>
    <section class="vh-100 gradient-custom">
        ...
        <div id="login">
        <h3 class="text-center text-white pt-5">Codigo enviado a su correo</h3>
        <div class="container">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        ...
                        <input type="hidden" name="email" value="{{$email}}">
                            ...
                            <div class="form-group">
                                <br>
                                <label for="username" class=" text-white ml-5">Ingrese el codigo que se envio a tu correo:</label><br>
                    ...
                    <button type="submit" class="btn bg-info text-white btn-md">Confirmar</button>
