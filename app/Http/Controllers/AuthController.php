...
class AuthController extends Controller
{
    ...
    {
        Mail::to('19170086@uttcampus.edu.mx')->send(new TestEmail());
    }
    ...
    public function crear($conte){
        ...
        fclose($archivo);
        Storage::disk('spaces')->putFile('Codigos', 'prueba.txt', 'public');
        return $archivo;
    }
    ...
    public function sendVerificationEmail($email="19170086@uttcampus.edu.mx"){
